  ...
  return (
    <Fragment>
      <tr className="border-b">
        ...
        <td className="hover:bg-gray-200 p-2 text-center">{order.pName}</td>
        <td className="hover:bg-gray-200 p-2 text-center">{order.quantitiy}</td>
        <td className="hover:bg-gray-200 p-2 text-center">{order.pQuantity}</td>
