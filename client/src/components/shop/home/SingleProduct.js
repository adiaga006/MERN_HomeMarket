                          ...
                          <div className="card p-3 rounded">
                            ...
                            <div className="card-body d-flex flex-column">
                              ...
                              {item.pQuantity !== 0 ? (
                                <Fragment>
                                  {layoutData.inCart !== null &&
                                    ...
                                    >
                                      ...
                                      >
                                        <path d="M11 9h2V6h3V4h-3V1h-2v3H8v2h3v3zm-4 9c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zm10 0c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2zm-9.83-3.25.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.08-.14.14-.3.14-.48 0-.55-.45-1-1-1H7.42l-.94-2H2v2h2l3.6 7.59-1.35 2.45C5.09 15.16 5 15.57 5 16c0 1.11.89 2 2 2h12v-2H7.16c-.14 0-.25-.11-.25-.25z"></path>
                                      </svg>
                                      Thêm vào giỏ
                                    </div>
                                  )}
                                ...
                                <div id="view_btn" className="btn btn-block">
                                  <span className="btn-danger">Đã hết hàng</span>
                                </div>
                              )}
                            </div>
                          </div>
